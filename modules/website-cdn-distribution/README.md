...
| <a name="input_logging_regional_domain_name"></a> [logging\_regional\_domain\_name](#input\_logging\_regional\_domain\_name) | The logging bucket region-specific domain name. | `string` | n/a | yes |
...
| <a name="input_website_regional_domain_name"></a> [website\_regional\_domain\_name](#input\_website\_regional\_domain\_name) | The website bucket region-specific domain name. | `string` | n/a | yes |
