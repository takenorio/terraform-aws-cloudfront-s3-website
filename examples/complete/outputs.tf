...
output "s3_bucket_logs_domain_name" {
  ...
  value       = "module.simple_website.s3_bucket_logs_bucket_domain_name"
}
...
output "s3_bucket_logs_regional_domain_name" {
  ...
  value       = "module.simple_website.s3_bucket_logs_bucket_regional_domain_name"
}
...
output "s3_bucket_web_domain_name" {
  ...
  value       = "module.simple_website.s3_bucket_web_bucket_domain_name"
}
...
output "s3_bucket_web_regional_domain_name" {
  ...
  value       = "module.simple_website.s3_bucket_web_bucket_regional_domain_name"
}
...
output "s3_bucket_acl_web_id" {
  ...
  value       = "module.simple_website.s3_bucket_acl_web_id"
}
